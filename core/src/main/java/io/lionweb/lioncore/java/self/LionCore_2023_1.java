...
public class LionCore_2023_1 {

  private LionCore_2023_1() {
    ...
    if (INSTANCE == null) {
      ...
      concept.addFeature(
          Property.createRequired(
              "abstract", LionCoreBuiltins_2023_1.getBoolean(), "-id-Concept-abstract"));
      concept.addFeature(
          Property.createRequired(
              "partition", LionCoreBuiltins_2023_1.getBoolean(), "-id-Concept-partition"));
      ...
      feature.addFeature(
          Property.createRequired(
              "optional", LionCoreBuiltins_2023_1.getBoolean(), "-id-Feature-optional"));
      ...
      link.addFeature(
          Property.createRequired(
              "multiple", LionCoreBuiltins_2023_1.getBoolean(), "-id-Link-multiple"));
      ...
      language.addFeature(
          Property.createRequired(
              "version", LionCoreBuiltins_2023_1.getString(), "-id-Language-version"));
      language.addFeature(
      ...
      iKeyed.addExtendedInterface(LionCoreBuiltins_2023_1.getINamed());
      iKeyed.addFeature(
          Property.createRequired("key", LionCoreBuiltins_2023_1.getString())
              .setID("-id-IKeyed-key"));
