...
public class LionCoreBuiltins_2023_1 extends Language {
  private static final LionCoreBuiltins_2023_1 INSTANCE = new LionCoreBuiltins_2023_1();

  /** This is private to prevent instantiation and enforce the Singleton pattern */
  private LionCoreBuiltins_2023_1() {
  ...
  public static LionCoreBuiltins_2023_1 getInstance() {
    return INSTANCE;
  }
