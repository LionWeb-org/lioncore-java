...
public class LionCoreBuiltins_2024_1 extends Language {
  private static final LionCoreBuiltins_2024_1 INSTANCE = new LionCoreBuiltins_2024_1();

  /** This is private to prevent instantiation and enforce the Singleton pattern */
  private LionCoreBuiltins_2024_1() {
    super("LionCore_builtins");
    setID("LionCore-builtins");
    setKey("LionCore-builtins");
    setVersion(JsonSerialization.SERIALIZATION_FORMAT_2024_1);
  ...
  public static LionCoreBuiltins_2024_1 getInstance() {
    return INSTANCE;
  }
